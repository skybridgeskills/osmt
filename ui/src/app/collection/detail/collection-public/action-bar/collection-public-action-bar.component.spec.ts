...
@Component({
  template: ` <app-collection-public-action-bar
...
export function createComponent(T: Type<TestHostComponent>): Promise<void> {
  ...
  const debugEl = hostFixture.debugElement.query(
    By.directive(CollectionPublicActionBarComponent)
  );
...
describe('CollectionPublicActionBarComponent', () => {
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [CollectionPublicActionBarComponent, TestHostComponent],
      providers: [
        ToastService,
