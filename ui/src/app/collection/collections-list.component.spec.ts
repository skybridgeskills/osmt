...
describe('CollectionsListComponent', () => {
  ...
  it('setResults should set results', () => {
    ...
    expect(component.curPageCount).toEqual(
      paginatedCollections.collections.length
    );
  ...
  it('rowActions should be correct', () => {
    ...
    const collection1 = createMockCollectionSummary(
      'id2',
    ...
    const collection2 = createMockCollectionSummary(
      'id3',
      PublishStatus.Draft,
      ''
    );
  ...
  it('tableActions should be correct', () => {
    ...
    const collection0 = createMockCollectionSummary(
      'id3',
      PublishStatus.Draft,
      ''
    );
    ...
    const collection3 = createMockCollectionSummary(
      'id2',
      PublishStatus.Archived
    );
  ...
  it('getSelectedSkills should be correct', () => {
    ...
    expect(component.getSelectedSkills(undefined)).toEqual(
      component.selectedCollections
    );

    const collection = createMockCollectionSummary();
    expect(component.getSelectedSkills()).toEqual([collection]);
  });
  ...
  it('selectedUuids should be correct', () => {
    ...
    expect(component.selectedUuids(undefined)).toEqual([
      component.selectedCollections[0].uuid,
    ]);

    const collection = createMockCollectionSummary();
    expect(component.selectedUuids()).toEqual([collection.uuid]);
  });
  ...
  it('getApiSearch should be correct', () => {
    ...
    expect(component.getApiSearch(undefined)).toEqual(undefined);
