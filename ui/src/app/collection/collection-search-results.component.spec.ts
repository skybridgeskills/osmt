...
export function createComponent(
  T: Type<CollectionSearchResultsComponent>,
  f?: () => void
): Promise<void> {
...
describe('CollectionSearchResultsComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [CollectionSearchResultsComponent],
      imports: [
  ...
  it('getApiSearch should return', () => {
    ...
    const apiSearch = new ApiSearch({ query });
    component.apiSearch = apiSearch;
    component.results = createMockPaginatedCollections(
      component.size,
      component.size * 2
  ...
  it('getSelectAllCount should return', () => {
    // Arrange
    const collections = createMockPaginatedCollections(
      component.size,
      component.size * 2
    );
