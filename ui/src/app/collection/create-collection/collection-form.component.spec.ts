...
export function createComponent(
  T: Type<CollectionFormComponent>
): Promise<void> {
...
describe('CollectionFormComponent', () => {
  ...
  it('namedReferenceForString should be correct', () => {
    ...
    expect(component.namedReferenceForString('a://b')).toEqual(
      new ApiNamedReference({ id: 'a://b' })
    );
    expect(component.namedReferenceForString('abc')).toEqual(
