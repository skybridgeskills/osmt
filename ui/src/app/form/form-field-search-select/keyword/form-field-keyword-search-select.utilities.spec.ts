...
describe('form-field-keyword-search-select.utilities', () => {
  ...
  it('areAlignmentsEqual should return correct result', () => {
    const copy = new ApiAlignment({
      id: testAlignment1.id,
      skillName: testAlignment1.skillName,
    });
  ...
  it('labelForAlignment should return correct result', () => {
    expect(labelForAlignment(testAlignment1)).toEqual(
      testAlignment1.skillName!
    );
  });

  it('searchServiceResultToAlignment should return correct result', () => {
    expect(
      searchServiceResultToAlignment({ id: '', name: testAlignment1.skillName })
    ).toEqual(testAlignment1);
    expect(searchServiceResultToAlignment(testAlignment1.skillName)).toEqual(
      testAlignment1
    );
  });

  it('areNamedReferencesEqual should return correct result', () => {
    const copy = new ApiNamedReference({
      id: testNamedReference1.id,
      name: testNamedReference1.name,
    });
    expect(areNamedReferencesEqual(testNamedReference1, copy)).toEqual(true);
    expect(
      areNamedReferencesEqual(testNamedReference1, testNamedReference2)
    ).toEqual(false);
  });
  ...
  it('isNamedReferenceKeywordType should return correct result', () => {
    ...
    expect(isNamedReferenceKeywordType(KeywordType.Certification)).toEqual(
      true
    );
  ...
  it('labelForNamedReference should return correct result', () => {
    expect(labelForNamedReference(testNamedReference1)).toEqual(
      testNamedReference1.name!
    );
  });

  it('searchServiceResultToNamedReference should return correct result', () => {
    expect(searchServiceResultToNamedReference(testNamedReference1)).toEqual(
      testNamedReference1
    );
    expect(
      searchServiceResultToNamedReference(testNamedReference1.name)
    ).toEqual(testNamedReference1);
  });
  ...
  it('areStringKeywordsEqual should return correct result', () => {
    ...
    expect(
      areStringKeywordsEqual(testStringKeyword1, testStringKeyword2)
    ).toEqual(false);
  });
  ...
  it('isStringKeywordType should return correct result', () => {
    ...
    expect(isStringKeywordKeywordType(KeywordType.Certification)).toEqual(
      false
    );
  ...
  it('labelForStringKeyword should return correct result', () => {
    expect(labelForStringKeyword(testStringKeyword1)).toEqual(
      testStringKeyword1
    );
  });
  ...
  it('searchServiceResultToStringKeyword should return correct result', () => {
    expect(
      searchServiceResultToStringKeyword({ id: '', name: testStringKeyword1 })
    ).toEqual(testStringKeyword1);
    expect(searchServiceResultToStringKeyword(testStringKeyword1)).toEqual(
      testStringKeyword1
    );
  });
  ...
  it('areSearchResultsEqual should return correct result', () => {
    ...
    expect(areSearchResultsEqual(testAlignment1, testNamedReference1)).toEqual(
      false
    );
    expect(areSearchResultsEqual(testAlignment1, testStringKeyword1)).toEqual(
      false
    );
    expect(areSearchResultsEqual(testNamedReference1, testAlignment1)).toEqual(
      false
    );
    expect(
      areSearchResultsEqual(testNamedReference1, testNamedReference1)
    ).toEqual(true);
    expect(
      areSearchResultsEqual(testNamedReference1, testStringKeyword1)
    ).toEqual(false);
    expect(areSearchResultsEqual(testStringKeyword1, testAlignment1)).toEqual(
      false
    );
    expect(
      areSearchResultsEqual(testStringKeyword1, testNamedReference1)
    ).toEqual(false);
    expect(
      areSearchResultsEqual(testStringKeyword1, testStringKeyword1)
    ).toEqual(true);
  });
  ...
  it('searchResultFromString should return correct result', () => {
    expect(
      searchResultFromString(KeywordType.Alignment, testAlignment1.skillName!)
    ).toEqual(testAlignment1);
    expect(
      searchResultFromString(KeywordType.Author, testStringKeyword1)
    ).toEqual(testStringKeyword1);
    expect(
      searchResultFromString(KeywordType.Category, testNamedReference1.name!)
    ).toEqual(testStringKeyword1);
    expect(
      searchResultFromString(
    ...
    expect(
      searchResultFromString(KeywordType.Employer, testNamedReference1.name!)
    ).toEqual(testNamedReference1);
    expect(
      searchResultFromString(KeywordType.Keyword, testStringKeyword1)
    ).toEqual(testStringKeyword1);
    expect(
      searchResultFromString(KeywordType.Standard, testAlignment1.skillName!)
    ).toEqual(testAlignment1);
  });
});
