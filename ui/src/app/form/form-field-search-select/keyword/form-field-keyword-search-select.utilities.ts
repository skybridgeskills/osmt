...
export const areAlignmentsEqual = (
  value1: IAlignment,
  value2: IAlignment
): boolean => {
...
export const areNamedReferencesEqual = (
  value1: INamedReference,
  value2: INamedReference
): boolean => {
...
export const labelForNamedReference = (
  value: INamedReference
): string | null => {
...
export const searchServiceResultToNamedReference = (
  ...
  if (result) {
    return isNamedReference(result)
      ? result
      : ApiNamedReference.fromString(result);
  }

  return undefined;
};

export const areStringKeywordsEqual = (
  value1: string,
  value2: string
): boolean => {
...
export const labelFor = (
  value: IAlignment | INamedReference | string
): string | null => {
