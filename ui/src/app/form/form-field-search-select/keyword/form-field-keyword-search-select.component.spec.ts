...
import { FormFieldKeywordSearchSelect } from './form-field-keyword-search-select.component';

@Component({
  template:
    '<app-form-field-keyword-search-select></app-form-field-keyword-search-select>',
})
export abstract class TestHostComponent extends FormFieldKeywordSearchSelect {
...
describe('FormFieldKeywordSearchSelectComponent', () => {
  beforeEach(() => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [FormFieldKeywordSearchSelect, TestHostComponent],
      imports: [
  ...
  it('searchResultFromString should return correct result', () => {
    expect(component.searchResultFromString(testResult1.name!)).toEqual(
      testResult1
    );
  });
