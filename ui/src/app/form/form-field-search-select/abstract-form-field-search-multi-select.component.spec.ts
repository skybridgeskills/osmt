...
export abstract class TestHostComponent extends AbstractFormFieldSearchMultiSelect<ITestValueType> {
  ...
  execProtected = {
    ...
    handleSearchResultClicked: (result: ITestValueType) =>
      this.handleSearchResultClicked(result),
    handleSelectedResultClicked: (result: ITestValueType) =>
...
describe('AbstractFormFieldSearchMultiSelectComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [AbstractFormFieldSearchMultiSelect, TestHostComponent],
      imports: [
