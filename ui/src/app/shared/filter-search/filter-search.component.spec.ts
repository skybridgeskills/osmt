...
describe('FilterSearchComponent', () => {
  ...
  it('are results equals should be true', () => {
    const areEqual = filterSearch.areResultsEqual(
      apiNameReferenced1,
      apiNameReferenced1
    );
  ...
  it('are results equals should be false', () => {
    const areEqual = new FilterSearchComponent().areResultsEqual(
      apiNameReferenced1,
      apiNameReferenced2
    );
  ...
  it('name should be correct for api job code', () => {
    const name = filterSearch.resultName(
      new ApiJobCode({ code: 'code1', targetNodeName: 'value1' })
    );
