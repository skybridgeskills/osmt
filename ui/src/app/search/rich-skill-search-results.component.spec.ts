...
export function createComponent(
  T: Type<RichSkillSearchResultsComponent>,
  f?: () => void
): Promise<void> {
...
describe('RichSkillSearchResultsComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [RichSkillSearchResultsComponent],
      imports: [
  ...
  it('getApiSearch should return', () => {
    ...
    const apiSearch = new ApiSearch({ query });
    component.apiSearch = apiSearch;
    component.results = createMockPaginatedSkills(
      component.size,
      component.size * 2
    ); // Prep for handleSelectAll call: >1 page
  ...
  it('getSelectAllCount should return', () => {
    // Arrange
    const skills = createMockPaginatedSkills(
      component.size,
      component.size * 2
    );
  ...
  it('handleClickExportSearchCsv should call subject loader and services methods', () => {
    const spyExportSearch = spyOn(
      component['richSkillService'],
      'exportSearchCsv'
    ).and.returnValue(of(mockTaskResultForExportSearch));
    const spyGetResult = spyOn(
      component['richSkillService'],
      'getResultExportedCsvLibrary'
    ).and.returnValue(of('csv,csv'));
    component['getRsdCsv']();
