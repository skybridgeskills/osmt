...
import {
  ...
  getLabelForSortOrder,
} from './category-table.component';
...
describe('CategoryTableComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [CategoryTableComponent, TestHostComponent],
      imports: [
  ...
  it('get mobileSortOrderOptions should return correct value', () => {
    expect(component.mobileSortOrderOption!.value).toEqual(
  ...
  it('handleMobileSortOrderSelected should succeed', () => {
    expect(
      (() => {
        component.handleMobileSortOrderSelected({
          label: '',
          value: KeywordSortOrder.SkillCountDesc,
        });
        return true;
      })()
    ).toEqual(true);
...
describe('getLabelForSortOrder', () => {
  it('should return correct values', () => {
    expect(getLabelForSortOrder(KeywordSortOrder.KeywordAsc)).toEqual(
      'Category name (ascending)'
    );
    expect(getLabelForSortOrder(KeywordSortOrder.KeywordDesc)).toEqual(
      'Category name (descending)'
    );
    expect(getLabelForSortOrder(KeywordSortOrder.SkillCountAsc)).toEqual(
      'Skill count (ascending)'
    );
    expect(getLabelForSortOrder(KeywordSortOrder.SkillCountDesc)).toEqual(
      'Skill count (descending)'
    );
  });
});
