...
export class CategoryTableComponent {
  @ViewChildren(CategoryTableRowComponent) rowReferences:
    | QueryList<CategoryTableRowComponent>
    | undefined = undefined;
  ...
  readonly mobileSortOptionMap: Map<
    KeywordSortOrder,
    ISelectOption<KeywordSortOrder>
  > = new Map(
    [
      ...
      sortOrder,
      { label: getLabelForSortOrder(sortOrder), value: sortOrder },
    ])
  );
...
export function getLabelForSortOrder(sortOrder: KeywordSortOrder): string {
  switch (sortOrder) {
    case KeywordSortOrder.KeywordAsc:
      return 'Category name (ascending)';
    case KeywordSortOrder.KeywordDesc:
      return 'Category name (descending)';
    case KeywordSortOrder.SkillCountAsc:
      return 'Skill count (ascending)';
    case KeywordSortOrder.SkillCountDesc:
      return 'Skill count (descending)';
    default:
      return '';
  }
}
