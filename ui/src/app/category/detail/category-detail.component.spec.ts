...
describe('CategoryDetailComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [CategoryDetailComponent, TestHostComponent],
      imports: [
  ...
  it('get skillsCountLabel should return correct result', () => {
    expect(component.skillsCountLabel).toEqual(
      '0 RSDs with this category based on'
    );

    component.skillTableControl.loadSkills(1);
    expect(component.skillsCountLabel).toEqual(
      `${component.skillTableControl.totalCount} RSDs with this category based on`
    );
  });
  ...
  it('handleStatusFilterChange should succeed', () => {
    expect(
      (() => {
        component.handleStatusFilterChange(
