...
describe('CategoryDetailCardComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [CategoryDetailCardComponent, TestHostComponent],
      imports: [
  ...
  it('get categorySkillsLabel should return correct result', () => {
    ...
    component.category = CategoryServiceData.category;
    expect(component.categorySkillsLabel).toEqual(
      `${CategoryServiceData.category.skillCount} RSDs with category.`
    );
    ...
    expect(component.categorySkillsLabel).toEqual(
      `${CategoryServiceData.category.skillCount} RSDs with category. Viewing ${component.firstSkillIndex}-${component.lastSkillIndex}.`
    );
  });
  ...
  it('get categorySkillCount should return correct result', () => {
    ...
    component.category = CategoryServiceData.category;
    expect(component.categorySkillCount).toEqual(
      `${CategoryServiceData.category.skillCount}`
    );
  });
