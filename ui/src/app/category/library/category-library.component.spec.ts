...
import { CategoryLibraryComponent } from './category-library.component';

@Component({
  template: '',
})
export abstract class TestHostComponent extends CategoryLibraryComponent {
  execProtected = {};
}
...
describe('CategoryLibraryComponent', () => {
  beforeEach(() => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [CategoryLibraryComponent, TestHostComponent],
      imports: [
