...
export class RelatedSkillTableControl<TEntityId> implements ISkillTableControl {
  ...
  constructor(
    ...
    this.statusFilters =
      control?.statusFilters ?? new Set([PublishStatus.Published]);
  ...
  get currLastSkillIndex(): number | undefined {
    return this.hasResults &&
      this.currFirstSkillIndex !== undefined &&
      this.currPageCount !== undefined
      ? this.currFirstSkillIndex + this.currPageCount
      : undefined;
  }
