...
class Page extends TestPage<BatchImportComponent> {
  get myElement(): HTMLInputElement {
    return this.query<HTMLInputElement>('#mycomponent-mytype-myelement');
  }
...
describe('BatchImportComponent', () => {
  ...
  it('getImportOptionButtonLabel() should return correct values', () => {
    ...
    expect(component.getImportOptionButtonLabel()).toEqual(
    ...
    data: [
      {
        ...
        Keywords:
          '.NET Framework; ADO.NET; Language Integrated Query (LINQ); WCF Data Services; XML',
        Standards: '15-0000',
        Certifications: '15-1200',
        'Occupation Major Groups': '15-1220; 15-1250; 15-1290',
        'Occupation Minor Groups':
          '15-1251; 15-1252; 15-1253; 15-1254; 15-1255; 15-1221; 15-1299',
        'Broad Occupations': '',
        'Detailed Occupations': '',
        'O*NET Job Codes': '',
        Employers: '.NET Framework',
        'Alignment Name':
          'https://skills.emsidata.com/skills/KS1200B62W5ZF38RJ7TD',
      },
      {
        'RSD Name': '',
      },
