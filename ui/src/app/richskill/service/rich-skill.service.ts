...
export class RichSkillService extends AbstractService {
  ...
  getSkillByUUID(uuid: string): Observable<ApiSkill> {
    ...
    return this.get<ISkill>({
      ...
      .pipe(share())
      .pipe(
        map(({ body }) => new ApiSkill(this.safeUnwrapBody(body, errorMsg)))
      );
  }
  ...
  getSkillXlsxByUuid(uuid: string): Observable<string> {
    ...
    return this.httpClient
      ...
      .pipe(share())
      .pipe(
        map(response => this.safeUnwrapBody(response.body as string, errorMsg))
      );
  }
    ...
    return this.post<ApiSkillSummary[]>({
      ...
      .pipe(
        map(({ body, headers }) => {
          ...
          return new PaginatedSkills(
            skills,
            !isNaN(totalCount) ? totalCount : skills.length
          );
        })
      );
  }
  ...
  libraryExportCsv(): Observable<ApiTaskResult> {
    return this.httpClient
      .get<ApiTaskResult>(this.buildUrl('export/library/csv'), {
        headers: this.wrapHeaders(
          new HttpHeaders({
            Accept: 'application/json',
          })
  ...
  libraryExportXlsx(): Observable<ApiTaskResult> {
    return this.httpClient
      .get<ApiTaskResult>(this.buildUrl('export/library/xlsx'), {
        headers: this.wrapHeaders(
          new HttpHeaders({
            Accept: 'application/json',
          })
  ...
  exportSearchCsv(
    ...
    return this.httpClient
      .post<ApiTaskResult>(this.buildUrl('export/skills/csv'), apiSearch, {
        params,
        headers: this.wrapHeaders(
          new HttpHeaders({
            Accept: 'application/json',
  ...
  exportSearchXlsx(
    ...
    return this.httpClient
      .post<ApiTaskResult>(this.buildUrl('export/skills/xlsx'), apiSearch, {
        params,
        headers: this.wrapHeaders(
          new HttpHeaders({
            Accept: 'application/json',
  ...
  auditLog(skillUuid?: string): Observable<ApiAuditLog[]> {
