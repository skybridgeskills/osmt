...
export function createComponent(T: Type<TestHostComponent>): Promise<void> {
  ...
  const debugEl = hostFixture.debugElement.query(
    By.directive(SkillListRowComponent)
  );
...
describe('SkillListRowComponent', () => {
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [SkillListRowComponent, TestHostComponent],
    }).compileComponents();
  ...
  it('selected should emit', () => {
    ...
    childComponent.rowSelected
      .pipe(first())
      .subscribe((skill: ApiSkillSummary) => (skillSummary = skill));
  ...
  it('isStatus should return status', () => {
    // Arrange
    childComponent.skill = new ApiSkillSummary(
  ...
  it('isPublished should return', () => {
    // Arrange
    childComponent.skill = new ApiSkillSummary(
      createMockSkillSummary('id1', PublishStatus.Published)
    );
