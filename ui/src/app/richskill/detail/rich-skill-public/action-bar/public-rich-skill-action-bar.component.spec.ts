...
@Component({
  template: ` <app-abstract-public-rich-skill-action-bar
    [skillUrl]="skillUrl"
    [skillUuid]="skillUuid"
    [skillName]="skillName"
...
export function createComponent(T: Type<TestHostComponent>): Promise<void> {
  ...
  const debugEl = hostFixture.debugElement.query(
    By.directive(PublicRichSkillActionBarComponent)
  );
...
describe('PublicRichSkillActionBarComponent', () => {
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [PublicRichSkillActionBarComponent, TestHostComponent],
      providers: [
        ToastService,
  ...
  it('onCopyURL should return', () => {
    // Arrange
    const element: HTMLTextAreaElement = document.createElement(
      'TextArea'
