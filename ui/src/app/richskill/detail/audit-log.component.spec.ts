...
describe('AuditLogComponent', () => {
  ...
  it('iconForEntry should return', () => {
    [
      ...
      {
        op: AuditOperationType.PublishStatusChange,
        new: PublishStatus.Published,
        expected: component.publishIcon,
      },
      {
        op: AuditOperationType.PublishStatusChange,
        new: PublishStatus.Archived,
        expected: component.archiveIcon,
      },
      {
        op: AuditOperationType.PublishStatusChange,
        new: PublishStatus.Unarchived,
        expected: component.unarchiveIcon,
      },
      {
        op: AuditOperationType.PublishStatusChange,
        new: PublishStatus.Deleted,
        expected: component.archiveIcon,
      },
      {
        op: AuditOperationType.PublishStatusChange,
  ...
  it('visibleFieldName should return', () => {
    [
      ...
      expect(component.visibleFieldName(params.fieldname)).toEqual(
        params.expected
      );
    });
  });
