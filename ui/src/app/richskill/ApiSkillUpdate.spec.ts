...
describe('ApiSkillUpdate', () => {
  it('ApiSkillUpdate should be created', () => {
    ...
    expect(deepEqualSkipOuterType(apiSkillUpdate, iSkillUpdate)).toBeTruthy(
      mismatched(apiSkillUpdate, iSkillUpdate)
    );
  });
  ...
  it('ApiStringListUpdate should be created', () => {
    ...
    // Act
    const apiStringListUpdate = new ApiStringListUpdate(
      iStringListUpdate.add,
      iStringListUpdate.remove
    );

    // Assert
    expect(apiStringListUpdate).toBeTruthy();
    expect(
      deepEqualSkipOuterType(apiStringListUpdate, iStringListUpdate)
    ).toBeTruthy(mismatched(apiStringListUpdate, iStringListUpdate));
  });
  ...
  it('ApiReferenceListUpdate should be created', () => {
    ...
    // Act
    const apiReferenceListUpdate = new ApiReferenceListUpdate(
      ref.add,
      ref.remove
    );
    ...
    expect(deepEqualSkipOuterType(apiReferenceListUpdate, ref)).toBeTruthy(
      mismatched(apiReferenceListUpdate, ref)
    );
  });
});
