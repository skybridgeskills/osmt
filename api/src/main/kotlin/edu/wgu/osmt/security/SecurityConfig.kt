            ...
            .authorizeHttpRequests { auth ->
                auth
                    ...
                    .requestMatchers(
                        ...
                        "${RoutePaths.API}${RoutePaths.UNVERSIONED}${RoutePaths.COLLECTION_XLSX}",
                    ).permitAll()
                    .requestMatchers(
                        GET,
                        ...
                        "${RoutePaths.API}${RoutePaths.UNVERSIONED}${RoutePaths.TASK_DETAIL_MEDIA}",
                    ).permitAll()
            }.exceptionHandling()
        ...
        http.authorizeHttpRequests { auth ->
            auth
                ...
                .requestMatchers(
                    ...
                    "${RoutePaths.API}${RoutePaths.API_V3}${RoutePaths.COLLECTIONS_LIST}",
                    "${RoutePaths.API}${RoutePaths.API_V2}${RoutePaths.COLLECTIONS_LIST}",
                    "${RoutePaths.API}${RoutePaths.UNVERSIONED}${RoutePaths.UNVERSIONED}${RoutePaths.COLLECTIONS_LIST}",
                ).permitAll()
                .requestMatchers(
                    POST,
                    "${RoutePaths.API}${RoutePaths.API_V3}${RoutePaths.SKILL_UPDATE}",
