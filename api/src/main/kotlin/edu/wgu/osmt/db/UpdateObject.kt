...
interface HasPublishStatus<T : MutablePublishStatusDetails> {
    ...
    fun applyPublishStatus(dao: T) {
        when (publishStatus) {
            ...
            // TODO this behavior won't allow "publishing" (though the date is set) if an archive date is still present see PublishStatusDetails#publishStatus
