...
data class RichSkillAndCollections(
    val rs: RichSkillDescriptor,
...
data class CollectionAndRichSkills(
    val collection: Collection,
    val skills: Set<RichSkillDescriptor>,
) {
    companion object {
        fun fromDao(collectionDao: CollectionDao): CollectionAndRichSkills =
            CollectionAndRichSkills(
                collectionDao.toModel(),
                collectionDao.skills
                    .map {
                        it.toModel()
                    }.toSet(),
            )
