    ...
    constructor(
        ...
        override fun getDefaultAuthor(): KeywordDao {
            val authorUri: String? =
                if (appConfig.defaultAuthorUri.isBlank()) null else appConfig.defaultAuthorUri
        ...
        override fun findByValueOrUri(
            ...
            val condition =
                (table.keyword_type_enum eq type) and
                    (table.value eq value) and
                    (table.uri eq uri) and
                    (table.framework eq framework)
        ...
        override fun create(
            ...
            return if (!strippedValue.isNullOrBlank() || !strippedUri.isNullOrBlank()) {
                dao
                    .new {
