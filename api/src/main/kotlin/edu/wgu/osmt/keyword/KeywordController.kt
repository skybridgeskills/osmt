...
class KeywordController
    ...
    constructor(
        ...
        @GetMapping(
            "${RoutePaths.API}${RoutePaths.API_V3}${RoutePaths.CATEGORY_SKILLS}",
            produces = [MediaType.APPLICATION_JSON_VALUE],
        )
        @ResponseBody
        ...
        private fun allPaginated(
            ...
            when (sortEnum) {
                KeywordSortEnum.KeywordAsc -> {
                    query.orderBy(KeywordTable.value to SortOrder.ASC)
                }

                KeywordSortEnum.KeywordDesc -> {
                    query.orderBy(KeywordTable.value to SortOrder.DESC)
                }

                KeywordSortEnum.SkillCountAsc -> {
                    query.orderBy(
                ...
                KeywordSortEnum.SkillCountDesc -> {
                    query.orderBy(
                        wrapAsExpression<Int>(
                            RichSkillKeywords
        ...
        private fun searchRelatedSkills(
            ...
            uriComponentsBuilder
                ...
                .queryParam(RoutePaths.QueryParams.SORT, sort)
                .queryParam(
                    RoutePaths.QueryParams.STATUS,
                    statusFilters.joinToString(",").lowercase(),
                )
