...
internal class CsvResourceTest {
    ...
    fun goldenPathTest() {
        ...
        val columnDefinitions: Array<CsvColumn<TestCsvRow>> =
            arrayOf(
    ...
    fun testMissingHeaderValue() {
        ...
        // Execute / Verify
        assertThrows<CsvMissingHeaderException>(
            "\"Can't produce unit-test csv, one or more required column headers are missing.\"",
        ) {
            exporter.toCsv(data)
        }
    }
    ...
    fun <T> getCsvTestResource(
        ...
        object : CsvResource<T>(debugName) {
