...
class RichSkillRepositoryTest @Autowired constructor(
    ...
    fun `should update an existing skill`() {
        ...
        val created = richSkillRepository.create(
            RsdUpdateObject(
                name = name,
                statement = statement,
            ),
        ...
        val updated = richSkillRepository.update(
            RsdUpdateObject(
                id = created.id.value,
                name = newName,
    ...
    fun `should be able to bulk publish all pages of search results`() {
        ...
        val knownUpdates = (1..toPublishCount).toList().map {
        ...
        val batchResult = richSkillRepository.changeStatusesForTask(
            PublishTask(
    ...
    fun `should be able to bulk publish or archive skills based on uuids`() {
        ...
        val archiveResult = richSkillRepository.changeStatusesForTask(
            PublishTask(
